...
class WeightMatrixCalculator:
    ...
    def calculate_weighted_evaluation(self, target_group: str, rater_context: str, scores: Dict) -> float:
        """
    ...
    def calculate_weighted_evaluation_batch(self, evaluations: List[Dict]) -> List[Dict]:
        """
        ...
        for eval_data in evaluations:
            ...
            weighted_score = self.calculate_weighted_evaluation(target_group, rater_context, scores)
            ...
            results.append(
                {
                    ...
                    # Keep both keys for compatibility with different callers/tests
                    "weights_applied": weight_value if weight_value is not None else 1.0,
    ...
    def update_config(self, target_group: str, rater_context: str, weight: float):
        ...
        self.logger.info(f"Updated weight: {target_group}/{rater_context} = {weight}")
