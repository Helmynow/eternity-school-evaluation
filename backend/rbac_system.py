...
class RBACSystem:
    ...
    def revoke_permission(self, user_email: str, permission: PermissionType, revoked_by: str) -> bool:
        """
    ...
    def get_user_permissions(self, user_email: str) -> List[Dict]:
        ...
        for perm in role_perms:
            permissions.append({"permission": perm.value, "source": f"role:{role}", "unlimited": True})
