...
class EOMCategoryRecommender:
    ...
    achievement_keywords = {
        EOMCategory.OUTSTANDING_LEADERSHIP: [
            'led', 'lead', 'managed', 'initiated', 'coordinated', 'directed', 'supervised',
            'mentored', 'guided', 'oversaw', 'organized', 'strategic', 'vision', 'decision',
            'delegated', 'empowered', 'inspired', 'motivated', 'team leader', 'project lead'
        ],
        EOMCategory.TEAM_SPIRIT: [
            'helped', 'supported', 'colleagues', 'collaborated', 'teamwork', 'cooperation',
            'assisted', 'worked together', 'partnership', 'unified', 'synergy', 'coordination',
            'shared', 'contributed', 'team player', 'cross-functional', 'interdepartmental'
        ],
        EOMCategory.INNOVATION: [
            'improved', 'streamlined', 'automated', 'innovated', 'created', 'developed',
            'designed', 'implemented', 'optimized', 'enhanced', 'transformed', 'revolutionized',
            'pioneered', 'breakthrough', 'cutting-edge', 'creative solution', 'new approach',
            'process improvement', 'efficiency', 'productivity'
        ],
        EOMCategory.RISING_STAR: [
            'new employee', 'new to the school', 'first 6 months', 'quickly adapted',
            'exceeded expectations', 'eagerness', 'initiative', 'new hire', 'recently joined',
            'fast learner', 'quickly integrated', 'early success'
        ],
        EOMCategory.SERVICE_EXCELLENCE: [
            'punctual', 'reliable', 'consistent', 'dependable', 'on time', 'never late',
            'high standard', 'minimal supervision', 'self-directed', 'proactive',
            'zero late marks', 'submits early', 'no reminders needed', 'excellent attendance'
        ]
    }
    ...
    def suggest_category(self, achievement_text: str, nominee_role: str = None) -> Dict:
        ...
        return {
            'recommended_category': recommended_category.value if hasattr(recommended_category, 'value') else str(recommended_category),
    ...
    def _analyze_sentiment(self, text: str) -> float:
        ...
        positive_words = [
            ...
            'dedicated', 'committed', 'passionate', 'enthusiastic', 'proactive',
            'successful', 'achieved', 'accomplished', 'exceeded', 'surpassed',
            'improved', 'enhanced', 'positive', 'effective', 'efficient',
            'valuable', 'significant', 'meaningful', 'impactful', 'transformative'
        ]
        
        negative_words = [
            'failed', 'unsuccessful', 'poor', 'inadequate', 'ineffective',
