...
from backend.database import (
    Person, Cycle, EOMCycle, EOMNominee, EOMWinner, EOMVoter,
    EOMRotationRule, EOMCategory, StaffSegment
)
...
class EOMTestDataGenerator:
    ...
    def generate_test_people(self, db_session) -> List[Person]:
        ...
        people_data = [
            # Academic staff
            {'email': 'teacher1@eternity.edu', 'name': 'John Teacher', 'role': 'Mathematics Teacher', 'dept': 'Academics', 'segment': StaffSegment.NATIONAL},
            {'email': 'teacher2@eternity.edu', 'name': 'Jane Instructor', 'role': 'Science Teacher', 'dept': 'Academics', 'segment': StaffSegment.INTERNATIONAL},
            {'email': 'teacher3@eternity.edu', 'name': 'Bob Professor', 'role': 'English Teacher', 'dept': 'Academics', 'segment': StaffSegment.WHOLE_SCHOOL},
            {'email': 'teacher4@eternity.edu', 'name': 'Alice Lecturer', 'role': 'History Teacher', 'dept': 'Academics', 'segment': StaffSegment.NATIONAL},
            {'email': 'teacher5@eternity.edu', 'name': 'Charlie Faculty', 'role': 'Art Teacher', 'dept': 'Academics', 'segment': StaffSegment.INTERNATIONAL},
            
            # Admin staff
            {'email': 'admin1@eternity.edu', 'name': 'David Coordinator', 'role': 'Administrative Coordinator', 'dept': 'Administration', 'segment': StaffSegment.WHOLE_SCHOOL},
            {'email': 'admin2@eternity.edu', 'name': 'Eve Manager', 'role': 'Operations Manager', 'dept': 'Administration', 'segment': StaffSegment.NATIONAL},
            {'email': 'admin3@eternity.edu', 'name': 'Frank Director', 'role': 'HR Director', 'dept': 'Administration', 'segment': StaffSegment.INTERNATIONAL},
            {'email': 'admin4@eternity.edu', 'name': 'Grace Secretary', 'role': 'Executive Secretary', 'dept': 'Administration', 'segment': StaffSegment.WHOLE_SCHOOL},
            
            # Leaders (for nomination limits)
            {'email': 'leader1@eternity.edu', 'name': 'Henry Principal', 'role': 'School Principal', 'dept': 'Leadership', 'segment': StaffSegment.WHOLE_SCHOOL},
            {'email': 'leader2@eternity.edu', 'name': 'Iris VP', 'role': 'Vice Principal', 'dept': 'Leadership', 'segment': StaffSegment.NATIONAL},
            {'email': 'leader3@eternity.edu', 'name': 'Jack Head', 'role': 'Department Head', 'dept': 'Leadership', 'segment': StaffSegment.INTERNATIONAL},
            
            # Support staff
            {'email': 'support1@eternity.edu', 'name': 'Karen Assistant', 'role': 'Teaching Assistant', 'dept': 'Support', 'segment': StaffSegment.NATIONAL},
            {'email': 'support2@eternity.edu', 'name': 'Larry Helper', 'role': 'IT Support', 'dept': 'Support', 'segment': StaffSegment.INTERNATIONAL},
            
            # Inactive staff (for edge cases)
            {'email': 'inactive1@eternity.edu', 'name': 'Inactive Person', 'role': 'Former Teacher', 'dept': 'Academics', 'segment': StaffSegment.NATIONAL, 'active': False},
        ]
    ...
    def generate_test_cycles(self, db_session) -> List[Cycle]:
        ...
        cycles_data = [
            {'code': 'CYCLE-2024-Q1', 'name': '2024 Q1 Evaluation', 'start_date': date(2024, 1, 1), 'end_date': date(2024, 3, 31)},
            {'code': 'CYCLE-2024-Q2', 'name': '2024 Q2 Evaluation', 'start_date': date(2024, 4, 1), 'end_date': date(2024, 6, 30)},
            {'code': 'CYCLE-2024-Q3', 'name': '2024 Q3 Evaluation', 'start_date': date(2024, 7, 1), 'end_date': date(2024, 9, 30)},
            {'code': 'CYCLE-2024-Q4', 'name': '2024 Q4 Evaluation', 'start_date': date(2024, 10, 1), 'end_date': date(2024, 12, 31)},
        ]
    ...
    def generate_test_winners(self, db_session, eom_cycles: List[EOMCycle], people: List[Person]) -> List[EOMWinner]:
        ...
        # April 2024 - Academic winner (different person)
        if len(eom_cycles) > 3:
            winner4 = EOMWinner(
    ...
    def generate_test_nominations(self) -> List[TestNomination]:
        ...
        nominations.append(TestNomination(
            ...
            expected_errors=[],
            expected_warnings=[],
            description='Valid first-time nomination for academic category',
        ...
        nominations.append(TestNomination(
            ...
            expected_errors=[],
            expected_warnings=[],
            description='Valid admin nomination',
            edge_case_type='valid'
        ))
        ...
        nominations.append(TestNomination(
            ...
            expected_warnings=[],
            description='Cooldown period violation - Academic category (3 months cooldown)',
        ...
        nominations.append(TestNomination(
            ...
            expected_errors=['Nominee is within cooldown period'],
            expected_warnings=[],
            description='Cooldown period violation - Admin category (2 months cooldown)',
            edge_case_type='cooldown_violation'
        ))
        ...
        nominations.append(TestNomination(
            ...
            expected_warnings=[],
            description='Non-existent nominee',
    ...
    def generate_all_test_data(self, db_session) -> Dict:
        ...
        if cycles:
            rotation_rules = self.generate_test_rotation_rules(db_session, cycles[0].id)
        ...
        return {
            ...
            'rotation_rules': rotation_rules if cycles else [],
            'winners': winners,
