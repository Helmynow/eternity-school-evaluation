...
from backend.context_aware_bias_detection import ContextAware360BiasDetection, ContextBiasFinding, CrossContextAnalysis
...
class TestContextSpecificBias:
    ...
    def test_analyze_context_specific_bias_centrality(self, mock_db_session):
        ...
        findings = detector._analyze_context_specific_bias(context="peer_review", ratings=ratings, assignments=assignments)
    ...
    def test_analyze_context_specific_bias_harshness(self, mock_db_session):
        ...
        findings = detector._analyze_context_specific_bias(context="manager_review", ratings=ratings, assignments=assignments)
    ...
    def test_analyze_context_specific_bias_halo(self, mock_db_session):
        ...
        findings = detector._analyze_context_specific_bias(
            context="direct_report_review", ratings=ratings, assignments=assignments
        )
...
class TestContextPatterns:
    ...
    def test_detect_hierarchy_bias(self, mock_db_session):
        ...
        context_data = {
            "CEO": {"ratings": [4.5, 4.6, 4.7], "assignments": [], "raters": [], "targets": [], "rater_target_pairs": []},
            "manager_review": {
                "ratings": [4.0, 4.1, 4.2],
                "assignments": [],
                "raters": [],
...
class TestContextBalance:
    ...
    def test_analyze_context_balance_missing_contexts(self, mock_db_session):
        ...
        context_data = {
            "peer_review": {"ratings": [4.0, 4.5], "assignments": [], "raters": [], "targets": [], "rater_target_pairs": []}
    ...
    def test_get_target_context_analysis(self, mock_db_session):
        ...
        context_data = {
            ...
            "manager_review": {
                ...
                "raters": [],
                "targets": ["target@example.com"],
                "rater_target_pairs": [{"rater": "manager@example.com", "target": "target@example.com", "rating": 3.5}],
            },
        }
        ...
        analysis = detector.get_target_context_analysis(cycle_id=1, target_email="target@example.com")
